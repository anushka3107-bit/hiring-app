...
const PreviewCard: React.FC = () => {
  ...
  const requisitionDetails = dataContext?.state.requisitionDetails;
  const jobDetails = dataContext?.state.jobDetails;
  const interviewSettings = dataContext?.state.interviewSettings;
